...
import de.sambalmueslie.openevent.core.announcement.db.AnnouncementStorageService.Companion.AUTHOR_REFERENCE
...
class AnnouncementCrudService(
    ...
    fun create(author: Account, request: AnnouncementChangeRequest): Announcement {
        return create(author, request, mapOf(Pair(AUTHOR_REFERENCE, author)))
    }
