...
export const appRoutes: Route[] = [
  ...
  },
  {
    path: "category",
    loadChildren: () =>
      import("../core/category/category.routes").then((m) => m.routes),
    canActivate: [canActivateAuthRole],
  ...
  },
  {
    path: "settings",
    loadChildren: () =>
      import("../core/settings/settings.routes").then((m) => m.routes),
    canActivate: [canActivateAuthRole],
  ...
  },
  {
    path: "cache",
    loadChildren: () =>
      import("../core/cache/cache.routes").then((m) => m.routes),
    canActivate: [canActivateAuthRole],
  ...
  },
  {
    path: "mail",
    loadChildren: () =>
      import("../core/mail/mail.routes").then((m) => m.routes),
    canActivate: [canActivateAuthRole],
  ...
  },
  {
    path: "history",
    loadChildren: () =>
      import("../core/history/history.routes").then((m) => m.routes),
    canActivate: [canActivateAuthRole],
  ...
  },
  {
    path: "search",
    loadChildren: () =>
      import("../core/search/search.routes").then((m) => m.routes),
    canActivate: [canActivateAuthRole],
  ...
  },
  {
    path: "issue",
    loadChildren: () =>
      import("../core/issue/issue.routes").then((m) => m.routes),
    canActivate: [canActivateAuthRole],
