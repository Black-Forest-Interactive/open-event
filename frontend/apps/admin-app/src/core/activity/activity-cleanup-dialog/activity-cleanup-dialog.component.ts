...
export class ActivityCleanupDialogComponent {
  ...
  submit() {
    ...
    const timestamp = DateTime.fromJSDate(value.timestamp)
    const request: ActivityCleanupRequest = new ActivityCleanupRequest(timestamp.toFormat("yyyy-MM-dd'T'00:00:00"))
