...
@Component({
  ...
  imports: [MatCard, MatIcon, TranslatePipe, AccountComponent, DatePipe, RegistrationStatusComponent, MatDivider, MatMiniFabButton, RouterLink, MatPaginator, MatTableModule, LoadingBarComponent],
  standalone: true
})
