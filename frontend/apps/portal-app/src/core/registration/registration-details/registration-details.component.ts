...
export class RegistrationDetailsComponent {
  ...
  private requestParticipateSelf(request: ParticipateRequest) {
    ...
    this.reloading = true;
    this.service
      .addParticipant(this.data().registration.id, request)
  ...
  private requestEditSelf(request: ParticipateRequest) {
    ...
    this.reloading = true;
    this.service
      .changeParticipant(this.data().registration.id, request)
      .subscribe((r) => this.handleParticipateResponse(r));
  }
  ...
  private requestCancelSelf() {
    ...
    this.reloading = true;
    this.service
      .removeParticipant(this.data().registration.id)
      .subscribe((r) => this.handleParticipateResponse(r));
  }
