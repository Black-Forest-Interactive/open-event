...
export abstract class BaseService {
  ...
  protected getAll<T>(suffix = ''): Observable<Array<T>> {
  ...
  protected getPaged<T>(suffix: string, page: number, size: number, params = new HttpParams(), queryParams = ''): Observable<Page<T>> {
    const url = this.createUrl(suffix)
