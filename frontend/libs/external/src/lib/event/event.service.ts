...
export class EventService extends BaseService {
  ...
  ): Observable<ExternalParticipantChangeResponse> {
  ...
  changeParticipation(
    ...
    request: ExternalParticipantChangeRequest,
  ): Observable<ExternalParticipantChangeResponse> {
  ...
  confirmParticipation(
    id: string,
    participantId: string,
    request: ExternalParticipantConfirmRequest,
  ): Observable<ExternalParticipantConfirmResponse> {
    return this.post(
      id + "/participant/" + participantId + "/confirm",
      request,
    );
  }
}
